...
import { ChevronLeft, ChevronRight, Star, MapPin, Calendar as CalendarIcon, Clock } from 'lucide-react';
...
export default function BookingCustomize({ service, artist, bookingDetails, emotionTypes }: CustomizeProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        // For now, redirect to payment (simulated)
        router.get('/booking/payment', {
            ...data,
            price: service.price,
        });
    };
