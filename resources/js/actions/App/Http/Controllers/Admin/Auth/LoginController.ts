...
/**
* @see \App\Http\Controllers\Admin\Auth\LoginController::create
...
/**
* @see \App\Http\Controllers\Admin\Auth\LoginController::destroy
* @see app/Http/Controllers/Admin/Auth/LoginController.php:72
* @route '/admin/logout'
*/
